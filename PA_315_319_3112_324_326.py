...
mov_ott_ratings = movies_list[['ID', 'IMDb', 'Rotten Tomatoes']]
...
mov_ott_ratings['IMDb'].isnull().sum()


# In[37]:


mov_ott_ratings['Rotten Tomatoes'].isnull().sum()
...
mov_ott_ratings['IMDb'].fillna(0, inplace=True)
mov_ott_ratings['IMDb'].isnull().sum()
...
mov_ott_ratings['Rotten Tomatoes'].fillna(0, inplace=True)
mov_ott_ratings['Rotten Tomatoes'].isnull().sum()
...
mov_ott_ratings['Rating'] = avg_col2(mov_ott_ratings['IMDb'], mov_ott_ratings['Rotten Tomatoes'])
...
df = movies_list['Age'].astype('category')
...
df = movies_list['Year'].astype('category')
